% Sudah periksa tahap 1, selain berikut:
% periksa validasi
...
preparedDataFileName = "prepared_" + dataName + ".mat";
...
%% ///////////////// TAHAP 1 //////////////////
% (output = y; input = x, x-1, x-2, y-1, y-2)
...
% =========== STEP 0: Inisialisasi ============
% alpha = 0.7;      % NOTES: alpha boleh berbeda dengan NN tahap 1, karena training yang berlangsung berbeda
Error_min = Error_min/100;
% epoch_max = 500;  %        epoch_max boleh berbeda dengan NN tahap 1, karena training yang berlangsung berbeda
% =============================================
...
save("plantIdentificationOutput.mat", "data", "x_train2", "data_y_pred", "uoj", "uij", "vok", "vjk", "wol", "wkl")
% /////////////////////////////////////////////
